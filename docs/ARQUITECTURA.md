...
- **Aria, asistente general de onboarding/soporte continuo:** a diferencia de El Semillero (solo owner, solo para arrancar un proyecto nuevo), cualquier miembro puede preguntarle a Aria sobre un proyecto o tarea puntual, o en un chat general — pensado para bajar la curva de integración de gente nueva al equipo. *(Implementado: Edge Function `aria-assistant`, 3 modos de contexto validados server-side, tile propio en el Dashboard — ver `docs/ESTADO.md`.)*
